# Generated by Django 3.1 on 2021-02-08 19:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('designation', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='hr.title')),
                ('pay_grade', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='hr.grade')),
                ('staff_name', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('requested_start_date', models.DateField(default=datetime.date.today)),
                ('requested_end_date', models.DateField(default=datetime.date.today)),
                ('leave_type', models.CharField(choices=[('Annual Leave', 'Annual Leave'), ('Sick Leave', 'Sick Leave'), ('Casual Leave', 'Casual Leave'), ('Examination Leave', 'Examination Leave'), ('Maternity Leave', 'Maternity Leave'), ('Compassionate Leave', 'Compassionate Leave')], max_length=120)),
